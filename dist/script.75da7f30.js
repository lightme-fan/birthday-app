...
var _editIcon = _interopRequireDefault(require("./icons/edit-icon.png"));

var _trash_icon = _interopRequireDefault(require("./icons/trash_icon.png"));
          ...
          <div>
            ...
            <div>
              <button type="button" class="btn edit" data-toggle="modal" data-target="#exampleModal" value="${person.id}">
                <img class="edit icon" width="15px" src=${_editIcon.default} alt="Edit">
              </button>
              <button type="button" class="btn delete" data-toggle="modal" data-target="#exampleModal" value="${person.id}">
                <img class="delete icon" width="15px" src=${_trash_icon.default} alt="Delete">
              </button>
            </div>
          </div>
      </div>
...
},{"date-fns":"node_modules/date-fns/esm/index.js","./icons/edit-icon.png":"icons/edit-icon.png","./icons/trash_icon.png":"icons/trash_icon.png","./localStorage.js":"localStorage.js","./usefulvariables.js":"usefulvariables.js","./getAge.js":"getAge.js"}],"destroyPopup.js":[function(require,module,exports) {
"use strict";
